...
public class MailerEJB {
	...
	private String generateMessage(String login) {
	 ...
	 */
	public void sendEmail(String login, String toAddress) throws MessagingException {
		...
		msg.setContent(generateMessage(login), "text/html");
